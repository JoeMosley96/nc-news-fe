  ...
  return (
    <li className = "articleCard">
      <Card >
        ...
        <Card.Body>
          <Card.Title><p><a href={`/articles/${article.article_id}`} class="link-danger link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover">{article.title}</a></p>
          </Card.Title>
